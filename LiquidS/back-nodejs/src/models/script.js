...
deleteButton.addEventListener("click", () => {
  const newUl = deleteButton.parentNode;
  newUl.remove();
  calcule();
});
...
function addContent() {
  ...
  if (s == 0) {
    ...
    newUl.innerHTML = `
    <input type="text" minlength="3" maxlength="50" class="g" value="${
      content[0]
    }" disabled> 
    <input type="text" min="0" max="10000000" value="${content[1]}" disabled>
    <input type="text" min="0" max="10000000" value="${content[2]}" disabled>
    <input type="text" min="0" max="10000000" value="${
      isNaN(num[0]) ? "" : num[0].toFixed(2)
    }" class="a" disabled>
    <input type="text" min="0" max="10000000" value="${
      isNaN(num[1]) ? "" : num[1].toFixed(2)
    }" class="b" disabled>
    <input type="text" min="0" max="10000000" value="${
      isNaN(num[2]) ? "" : num[2].toFixed(2)
    }" class="c" disabled>
...
function calcule() {
  ...
  let num1 =
    parseFloat(totalHR.value) +
    parseFloat(totalHNR.value) -
    parseFloat(totalD.value);
...
const printValues = document.querySelectorAll(
  ".dataTopR input, .midHeader input, .dataBottom input, .downR input"
);
const inputValues = [];

function beforePrint() {
  let oculto = document.querySelectorAll(
    ".mainContainer, nav, button, select, footer"
  );
...
selectCompany.addEventListener("change", function () {
  ...
  const printCompanyLogo = document.querySelector(".printCompanyLogo");
  ...
  switch (selectedOption) {
    case "logo1":
      companyLogo.src = "/Logos/Logo1.png";
      printCompanyLogo.style.backgroundImage = "url(/Logos/Logo1.png)";
      ...
      break;
    case "logo2":
      companyLogo.src = "/Logos/Logo2.png";
      printCompanyLogo.style.backgroundImage = "url(/Logos/Logo2.png)";
      ...
      break;
    default:
      companyLogo.src = "/Logos/Logo3.png";
      printCompanyLogo.style.backgroundImage = "url(/Logos/Logo3.png)";
      break;
  }
});
